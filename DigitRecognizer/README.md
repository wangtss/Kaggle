...
The **CNN** model scored 0.98, slightly better. I checked other people's model, seems like this model works just fine. But when training the model, I used all the training data, and didn't split a validation set. This is something I probably should working on.
